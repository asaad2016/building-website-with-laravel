<form class="" role="form" method="post" action="{{ url('/adminpanal/setting/store') }}">
    {{ csrf_field() }}
    <div class="form-group{{ $errors->has('sitename') ? ' has-error' : '' }}">
        <div class="col-md-10">
            <input id="sitename" type="text" class="form-control" name="sitename" value="{{ old('sitename') }}">
    ...
    <div class="form-group{{ $errors->has('yt') ? ' has-error' : '' }}">
        <div class="col-md-10">
            <input id="yt" type="text" class="form-control" name="yt" value="{{ old('yt') }}">
    ...
    <div class="form-group{{ $errors->has('fb') ? ' has-error' : '' }}">
        <div class="col-md-10">
            <input id="fb" type="text" class="form-control" name="fb" value="{{ old('fb') }}">
    ...
    <div class="form-group{{ $errors->has('tw') ? ' has-error' : '' }}">
        <div class="col-md-10">
            <input id="tw" type="text" class="form-control" name="tw" value="{{ old('tw') }}">
