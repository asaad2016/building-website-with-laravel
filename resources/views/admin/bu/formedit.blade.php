...
<form class="bu_create" role="form" method="POST" action="{{ url('/adminpanal/bu/update/' . $bu->id) }}" enctype="multipart/form-data">
{{ csrf_field() }}
    ...
    <div class="form-group{{ $errors->has('bu_status') ? ' has-error' : '' }}">
        ...
        <label for="bu_status" class="control-label col-md-2 info">حالة العقار</label>
    </div>
