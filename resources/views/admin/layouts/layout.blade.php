...
<head>
  ...
  {!! Html::style('admin/css/dataTables.bootstrap.min.css') !!}
  ...
  {!! Html::style('admin/css/jquery-jvectormap.css') !!}
  {!! Html::style('admin/css/bootstrap-datepicker.min.css') !!}
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{ url('/adminpanal') }}" class="logo">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{url('/admin/img/user3-128x128.jpg') }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{url('/admin/img/user4-128x128.jpg') }}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">لديك {{ countmessage() }} رسالة</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                  @foreach(unreadmessage() as $message)
                    <li><!-- Task item -->
                      <a href="{{ url('/adminpanal/message/edit/' . $message->id) }}">
                        <h3 class="text-center">
                          {{ $message->firstname }}
                          
                        </h3>
                        <div class="pull-right">
                          {{ str_limit($message->bodymsg,20) }}
                        </div>
              ...
              <li class="footer">
                <a href="{{ url('/adminpanal/message/index') }}">اظهر كل الرسائل</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            <a href="{{ url('/')}}">
              <i class="fa fa-home text-aqua"></i> الموقع
            </a>
          </li>
...
{!! Html::script('admin/js/datatable.buttons.js') !!}
...
{!! Html::script('admin/js/jquery.knob.min.js') !!}
